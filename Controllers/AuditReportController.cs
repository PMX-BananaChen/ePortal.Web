...
namespace ePortal.Web.Controllers
{
    public class AuditReportController : Controller
    {
        ...
        public ActionResult AuditReport(string types, string star, string end)
        {
